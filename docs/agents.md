...
| 로컬 경로 | `C:/ai/ai_coding_pjt/260331_개인홈페이지만들기` |
...
| # | 태스크 | 상태 |
|---|--------|------|
| 01 | Impact Counter 애니메이션 | ✅ DONE |
| 02 | Career Timeline | ✅ DONE |
| 03 | LinkedIn URL | ⏳ 사용자 URL 대기 |
| 04 | GT-Suite 자동화 상세 | ✅ DONE |
| 05 | 6 Sigma BB 성과 | ✅ DONE |
| 06 | Research 섹션 보강 | ✅ DONE |
| 07 | Skills Progress Bar | ✅ DONE |
| 08 | 일본어/영어 실전 사례 | ✅ DONE |
| 09 | AI Crew 자동화 예시 | ✅ DONE |
| 10 | OG 이미지 / SEO 메타 | ✅ DONE |
| 11 | 다크/라이트 모드 토글 | ✅ DONE |
| 12 | Sitemap + robots.txt | ✅ DONE |
| 13 | 프로젝트 카드 이미지 / Private Access | ✅ DONE |
| 14 | 서버급 인증 전환 | ⏳ NEXT |
...
| 날짜 | 작업 | 커밋 |
|------|------|------|
| 2026-06-22 | 프로젝트 이미지, 키워드 카드, Private Access, 기술스택 정리 | 진행 중 |
| 2026-06-11 | docs 재구성 | - |
