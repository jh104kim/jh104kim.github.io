...
2. R600a BLDC 압축기 최초 개발 (2007~2008, 기여도 100%) — AC → BLDC 전환 국내 최초
3. 일본 Sales Engineer 활동 (2015~2018) — 도시바 등 Sales 360억 달성
4. C&M 품질그룹장 (2019~2021) — 내외부 품질 안정화
5. C&M 개발그룹장 (2021~2023) — 신모델 개발 및 외판 확대
6. AI Crew Leader (2024~ 현재) — GT-Suite 자동화 + AI 업무자동화 추진
