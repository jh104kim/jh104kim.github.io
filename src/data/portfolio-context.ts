export const portfolioKnowledge = {
	...
	projects: [
		...
		"Personal Life OS Dashboard — 건강·자산·투자·소비 데이터를 통합한 개인 대시보드. 개인정보 포함으로 인증 후 접근.",
		"은퇴 연금 분석 웹앱 — 9개 연금 상품과 절세 시나리오를 비교하는 개인 재무 앱. 개인정보 포함으로 인증 후 접근.",
	],
	research: [
...
- 접근: 개인정보 포함으로 인증 후 접근

### 은퇴 연금 분석 웹앱
- 기술: Vite, React 18, Recharts, Cloudflare Pages, Workers AI (Llama 3.1 8B), Tailwind CSS
- 설명: 은퇴 후 연금 상품 수령 전략과 현금흐름을 비교하는 개인 재무 앱 (MVP 완성)
- 기능: 4개 절세 시나리오 비교 (IRP 분산·국민연금 지연 수령 등), 건보료 슬라이더 시뮬레이터, AI 챗봇 탑재
- 접근: 개인정보 포함으로 인증 후 접근

## 기술 스킬
- AI / 자동화: Claude Code, ChatGPT, Grok, Python/SDK 자동화, GitHub Actions
- 디자인 / 콘텐츠 제작: Figma, Canva, Claude Design
- 엔지니어링: GT-Suite, ANSYS/ADINA, 6 Sigma BB, Data Science Lv3, GenPower Lv4
- Office / 협업: Excel, PowerPoint, Notion
