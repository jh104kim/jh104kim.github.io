...
export const highlights: Highlight[] = [
  ...
  },
  {
    ...
    situation: "기술 요구가 높은 일본 고객과 영업/기술 기준을 동시에 만족해야 했습니다.",
    action: "도시바·미츠비시·샤프와의 탑미팅을 주도하고 요구사항을 기술 언어로 구조화해 신규 Sales를 개시했습니다.",
    result: "초기 거래 개시와 장기 거래 기반 강화로 큰 인정을 받으며 성과를 누적했습니다.",
    kpis: ["Sales 360억", "도시바·미츠비시·샤프 탑미팅"],
    tags: ["Global", "Communication"],
  },
  {
    id: "sigma-bldc-parts",
    title: "6 Sigma BB — R600a BLDC 신규 부품 적합성 평가",
    situation: "BLDC 전환 개발에서 단계별 신규 부품의 품질 적합성을 검증해야 했습니다.",
    action: "6 Sigma 방법론으로 개발 단계별 신규 부품 적합성 평가 체계를 구축했습니다.",
